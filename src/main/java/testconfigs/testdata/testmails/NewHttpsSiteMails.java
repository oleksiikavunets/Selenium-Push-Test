...
public class NewHttpsSiteMails {
    ...
    private List<String> gravitecUA = new ArrayList<>(Arrays.asList(
            ...
            "Щоб інтегрувати ваш сайт з сервісом та розпочати збір push-підписників, будь ласка, виконайте наступні дії.",
            "Крок 1. Скопіюйте вказаний нижче код (скрипт) в HTML шаблон вашого сайту між тегами и . Чим вище тим краще:",
            "Крок 2. Додайте файли manifest.json",
            "і push-worker.js",
            "в кореневий каталог вашого сайту.",
    ...
    private List<String> wpushUK = new ArrayList<>(Arrays.asList(
            "Новий сайт створений у Вашому обліковому записі",
            "Вітаю! До Вашого облікового запису на wpush.biz було додано новий сайт:",
            "Щоб інтегрувати Ваш сайт з сервісом і почати збирати push-підписників, будь-ласка, виконайте наступні дії:",
            "Крок 1. Скопіюйте вказаний нижче код (скрипт) у HTML шаблон Вашого сайту між тегами и . Чим вище, тим краще.",
            "Крок 2. Додайте файли json manifest.json",
            "та push-worker.js",
            "Відкрити налаштування сайту",
